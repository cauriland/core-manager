import { ApplicationFactory } from "@cauriland/core-cli";
import { Container, Contracts, Providers, Types } from "@cauriland/core-kernel";
...
export class ServiceProvider extends Providers.ServiceProvider {
    public async register(): Promise<void> {
        ...
        if (this.isProcessTypeManager()) {
            ...
            const pkg: Types.PackageJson = require("@cauriland/core/package.json");
