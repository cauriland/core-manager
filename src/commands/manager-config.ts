import { Commands, Container, Contracts, Services } from "@cauriland/core-cli";
...
export class Command extends Commands.Command {
    ...
    private async generateManagerSection(options: Options): Promise<any> {
        const result: any = {
            plugins: [
                {
                    package: "@cauriland/core-logger-pino",
                },
                {
                    package: "@cauriland/core-database",
                },
                {
                    package: "@cauriland/core-snapshots",
                },
                {
                    package: "@cauriland/core-manager",
                },
            ],
        };
        ...
        if (Object.keys(packageOptions.plugins).length) {
            result.plugins.find((plugin) => plugin.package === "@cauriland/core-manager").options = packageOptions;
        }
